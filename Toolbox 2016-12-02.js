...
var staticcursor = 'https://github.com/sh48846/Tools/blob/main/Cursors/cursor%20hand.png?raw=true';
//var staticcursor = 'https://github.com/sh48846/Tools/blob/main/catframe1.png?raw=true';
var dynamiccursor = 'https://github.com/sh48846/Tools/blob/main/Cursors/fastcatanimation.ani';
        ...
        if (typeof jQuery == 'function') {
			...
			if (animateCursor) {
              ...
              function getOscillatingDelay() {
                const min = 100;   // fastest delay (ms)
                const max = 100;  // slowest delay (ms)
